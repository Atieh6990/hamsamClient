  ...
  <div>
    ...
    <div class="tag">
      <div dir="ltr" class="tag-time">
        <!--<div>{{this.timer}}</div>-->
        <div class="numbers" style="right: 84px;">{{days}} :</div>
        <div class="numbers" style="right: 50px;">{{hours}} :</div>
        <div class="numbers" style="right: 15px;">{{minutes}} :</div>
        <div class="numbers" style="right: -13px;">{{seconds}}</div>
      </div>
    </div>
  </div>
</template>
