  ...
  <div>
    ...
    <div class="tag">
      <div dir="ltr" class="tag-time">
        <!--{{this.timer}}-->
        <div class="numbers" style="right: 205px;">{{days}} : </div>
        <div class="numbers" style="right: 120px;">{{hours}} : </div>
        <div class="numbers" style="right: 35px;">{{minutes}} : </div>
        <div class="numbers" style="right: -35px;">{{seconds}}</div>
